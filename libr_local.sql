...
--
-- Хост: localhost
-- Время создания: Мар 04 2024 г., 16:36
...
CREATE TABLE `libraries` (
  ...
  `photo` varchar(255) NOT NULL DEFAULT 'library.jpg',
...
INSERT INTO `libraries` (`id`, `name`, `address`, `link`, `telephone`, `site`, `photo`, `history`, `is_published`) VALUES
(6, 'Инновационный Евразийский Университет', 'Улица Горького, 120/2, Павлодар городская администрация', 'https://go.2gis.com/7wge9', '7182314230', 'www.ineu.edu.kz', '1709056463.png', '', 1),
(10, 'Quemby Lowerydfg', 'Ut quidem dolor vel ', 'Anim omnis ullamco n', '9422211231', 'Officia qui eiusmod ', '1709492405.png', 'Est nulla labore dis', 1),
(13, 'Gisela Lopez', 'Dolor tenetur est qu', 'Ut expedita aut exer', '61111', 'Itaque quaerat est ', '1709495282.png', 'Ea voluptas iste qui', 1);
...
INSERT INTO `museums` (`id`, `name`, `address`, `link`, `telephone`, `email`, `photo`, `history`, `is_published`, `created_at`, `updated_at`) VALUES
(2, 'Selma Bullock', 'In qui rerum consequ', 'Sint placeat eius p', '35', 'daze@mailinator.com', '1709496154.png', 'Voluptas nisi cupida', 1, '2024-03-04', '2024-03-04');
...
(1, 'Вероника', 'nika@libr.kz', '$2y$10$OTJlMGRkOTIzOGVlZWY3YO1MEVlGXwtAzyo8R1QSI1XBzWVkHLBIC');
