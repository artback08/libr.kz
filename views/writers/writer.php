<?php require_once ROOT . '/views/layouts/header.php'; ?>
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb p-3 bg-body-tertiary rounded-3">
        ...
        <li class="breadcrumb-item active" aria-current="page"><?php echo htmlspecialchars($writer['name']); ?></li>
      ...
      <h6>Писатели</h6>
        <div class="col-lg-12">
          <div class="text-center">
            <img src="<?php echo URL; ?>/uploads/img/writers/<?php echo $writer['photo']; ?>" class="align-items-center" height="250" alt="<?php echo htmlspecialchars($writer['name']); ?>">
          </div>
          <h2 class="fw-normal text-center"><?php echo htmlspecialchars($writer['name']); ?></h2>
          <div class="writer__years text-center mb-3">
            ( <?php echo years($writer['years']); ?> гг. )
          </div>
          <p><?php echo htmlspecialchars($writer['biography']); ?></p>
        </div>
    </div>
