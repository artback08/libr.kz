    ...
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        ...
        <ul class="pl-5 nav col-12  col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
          <li><a href="<?php echo URL ?>/writers" class="nav-link px-4 text-white">Писатели</a></li>
          <li><a href="<?php echo URL ?>/museums" class="nav-link px-1 text-white">Музеи</a></li>
          <li><a href="<?php echo URL ?>/writers/add" class="nav-link px-2 text-white">Добавить </a></li>
          <!-- <li><a href="#" class="nav-link px-2 text-white">Союз Писателей</a></li> -->
        </ul>
